...
MainWindow::MainWindow(Team& team1, Team& team2, QWidget* parent): QMainWindow(parent), can_save(true), battle(false), ally_team(team1), enemy_team(team2) {
    ...
    //team creation
    QScrollArea* scroll_area1 = new QScrollArea();
    scroll_area1->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);
    scroll_area1->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
    scroll_area1->setWidgetResizable(true);

    QScrollArea* scroll_area2 = new QScrollArea();
    scroll_area2->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);
    scroll_area2->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
    ...
    scroll_area1->setWidget(ally_team_widget);
    
    enemy_team_widget=new CreateTeamWidget(true, this);
    splitter->addWidget(scroll_area2);
    scroll_area2->setWidget(enemy_team_widget);
